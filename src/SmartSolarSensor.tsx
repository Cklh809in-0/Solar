...
const Footer: FC = () => {
  return (
    <footer className="relative z-10 bg-white dark:bg-dracula-bg border-t border-gray-200 dark:border-dracula-current py-6 sm:py-8 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto text-center">
        <p className="text-gray-900 dark:text-dracula-comment">
